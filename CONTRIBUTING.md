...
When authentication, account settings, or project/workflow behavior changes, reconcile the user-facing README, [operations guide](docs/operations.md), `.env.example` when its contract changes, the relevant implementation note, [documentation index](docs/README.md), and this guide. Update the Phase 1E or Phase 2 evidence record when verified behavior changes.
...
- `drizzle/` contains ordered migrations; the latest required migration is part of readiness. Phase 2 workflow triggers and indexes are in the new `0007`/`0008` migrations only; do not rewrite earlier ancestry.
